...
export default function StockCard({ stockDetails }) {
  ...
  return (
    <div className='carousel-item w-[33%] max-md:w-full'>
      <div className="shadow-md rounded-lg overflow-hidden justify-between bg-gray-900 flex flex-col flex-grow w-1/3">
        ...
        <div className="bg-gray-800 px-4 py-3 md:px-6 md:py-4 flex justify-end">
